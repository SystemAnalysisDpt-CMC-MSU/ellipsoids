...
%     for n=1:6
%         h=modgen.common.hash('my sample text',algs{n});
...
if isempty(strcmp(meth,algs))
    modgen.common.throwerror('wrongInput',['Hash algorithm must be ' ...
        'MD2, MD5, SHA-1, SHA-256, SHA-384, or SHA-512']);
end
% create hash
