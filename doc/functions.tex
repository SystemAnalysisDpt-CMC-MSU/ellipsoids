...
\fontfamily{\familydefault}
\selectfont
\subsection{\texorpdfstring{gras.ellapx.smartdb.rels.EllTube.getField}{getField}}
\fontfamily{pcr}
\selectfont
\begin{lstlisting}
...
\fontfamily{\familydefault}
\selectfont
\subsection{\texorpdfstring{gras.ellapx.smartdb.rels.EllTubeProj.getField}{getField}}
\fontfamily{pcr}
\selectfont
\begin{lstlisting}
...
\fontfamily{\familydefault}
\selectfont
\subsection{\texorpdfstring{gras.ellapx.smartdb.rels.EllUnionTube.getField}{getField}}
\fontfamily{pcr}
\selectfont
\begin{lstlisting}
...
\fontfamily{\familydefault}
\selectfont
\subsection{\texorpdfstring{gras.ellapx.smartdb.rels.EllUnionTubeStaticProj.getField}{getField}}
\fontfamily{pcr}
\selectfont
\begin{lstlisting}
