...
lsysd = elltool.linsys.LinSysFactory.create(aMat, bMat, uBoundsEllObj, gMat, vEllObj); 
% reach set
rsdObj = elltool.reach.ReachContinuous(lsysd, X0EllObj, dirsMat, timeVec); 
psdObj = rsdObj.projection(BB);  % reach set projection onto (x1, x2)% plot projection of reach set external approximation:
subplot(2, 2, 3);
