...
firstSys = elltool.linsys.LinSysFactory.create(firstAMat, firstBMat, firstUBoundsEllObj);
% define system 2:
secAMat = [-1/6 0 -1/3; 0 0 1/3; 1/6 -1/6 -1/3];
secBMat = [1/6; 0; 0];
secUBoundsEllObj = ellipsoid(1);
secondSys = elltool.linsys.LinSysFactory.create(secAMat, secBMat, secUBoundsEllObj);
