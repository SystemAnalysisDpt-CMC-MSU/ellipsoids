...
\begin{eqnarray}
\beta_1 & = &
\min_{\langle (x-q_2),W_2(x-q_2)\rangle=1}\langle (x-q_1),W_1(x-q_1)\rangle,
\label{beta1}\\
\beta_2 & = & \min_{\langle (x-q_1),W_1(x-q_1)\rangle=1}\langle
(x-q_2),W_2(x-q_2)\rangle, \label{beta2}
\end{eqnarray}
