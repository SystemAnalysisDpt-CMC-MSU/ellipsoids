...
\end{verbatim}
\subsection{\texorpdfstring{smartdb.relations.ATypifiedStaticRelation.CubeStruct}{CubeStruct}}\label{method:smartdb.relations.ATypifiedStaticRelation.CubeStruct}
\begin{verbatim}
