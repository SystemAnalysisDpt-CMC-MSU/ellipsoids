...
\hyperref[secClassDescr:smartdb.relations.ARelation]{smartdb.relations.ARelation}:

\begin{list}{}{}
 \item addData
 \item addTuples
 \item addTuplesInternal
 \item dispOnUI
 \item displayInternal
 \item fromStructList
 \item getFieldProjection
 \item getJoinWithInternal
 \item getNTuples
 \item getSortIndex
 \item getTuples
 \item getTuplesFilteredBy
 \item getTuplesIndexedBy
 \item getTuplesInternal
 \item getTuplesJoinedWith
 \item getTuplesJoinedWithInternal
 \item getUniqueData
 \item getUniqueTuples
 \item isEqual
 \item isMe
 \item isMemberTuples
 \item isUniqueKey
 \item removeDuplicateTuples
 \item removeTuples
 \item sortBy
 \item toCell
 \item toCellIsNull
 \item toDispCell
 \item toFieldListInternal
 \item toMat
 \item unionWith
 \item writeToCSV
 \item writeToXLS
