...
\end{verbatim}
\section{smartdb.cubes.CubeStruct}
\subsection{\texorpdfstring{smartdb.cubes.CubeStruct.CubeStruct}{CubeStruct}}
\begin{verbatim}
...
\end{verbatim}
\subsection{\texorpdfstring{smartdb.cubes.CubeStruct.applyGetFunc}{applyGetFunc}}
\begin{verbatim}
...
\end{verbatim}
\subsection{\texorpdfstring{smartdb.cubes.CubeStruct.applySetFunc}{applySetFunc}}
\begin{verbatim}
...
\end{verbatim}
\subsection{\texorpdfstring{smartdb.cubes.CubeStruct.applyTupleGetFunc}{applyTupleGetFunc}}
\begin{verbatim}
...
Notes: this function currently has a lots of limitations:
  ...
  All this limitations will eventually go away though so stay tuned...
\end{verbatim}
\subsection{\texorpdfstring{smartdb.cubes.CubeStruct.clone}{clone}}
\begin{verbatim}
CLONE - creates a copy of a specified object via calling
        a copy constructor for the object class
...
Ouput:
  self: any [] - constructed object
\end{verbatim}
\subsection{\texorpdfstring{smartdb.cubes.CubeStruct.copyFrom}{copyFrom}}
\begin{verbatim}
...
\end{verbatim}
\subsection{\texorpdfstring{smartdb.cubes.CubeStruct.createInstance}{createInstance}}
\begin{verbatim}
CREATEINSTANCE - returns an object of the same class by calling a default
                 constructor (with no parameters)
...
Ouput:
  self: any [] - constructed object
\end{verbatim}
\subsection{\texorpdfstring{smartdb.cubes.CubeStruct.display}{display}}
\begin{verbatim}
DISPLAY - puts some textual information about CubeStruct object in screen
...
Input:
 regular:
     self.
\end{verbatim}
\subsection{\texorpdfstring{smartdb.cubes.CubeStruct.fromStructList}{fromStructList}}
\begin{verbatim}
...
\end{verbatim}
\subsection{\texorpdfstring{smartdb.cubes.CubeStruct.getCopy}{getCopy}}
\begin{verbatim}
...
Input:
  ...
  optional:
    same as for getData
\end{verbatim}
\subsection{\texorpdfstring{smartdb.cubes.CubeStruct.getData}{getData}}
\begin{verbatim}
  ...
  regular:
    ...
    SIsValueNull: struct [1,1] - structure containing a
       ...
       means that a corresponding cell doesn't not contain
          any value
\end{verbatim}
\subsection{\texorpdfstring{smartdb.cubes.CubeStruct.getFieldDescrList}{getFieldDescrList}}
\begin{verbatim}
...
Output:
  regular:
    value: char cell [1,nFields] - list of CubeStruct object field
        descriptions
\end{verbatim}
\subsection{\texorpdfstring{smartdb.cubes.CubeStruct.getFieldIsNull}{getFieldIsNull}}
\begin{verbatim}
...
\end{verbatim}
\subsection{\texorpdfstring{smartdb.cubes.CubeStruct.getFieldIsValueNull}{getFieldIsValueNull}}
\begin{verbatim}
...
Output:
  regular:
    isValueNullVec: logical[] - array of isValueNull indicators for the
       specified field
\end{verbatim}
\subsection{\texorpdfstring{smartdb.cubes.CubeStruct.getFieldNameList}{getFieldNameList}}
\begin{verbatim}
...
Iutput:
  regular:
    value: char cell [1,nFields] - list of CubeStruct object field
        names
\end{verbatim}
\subsection{\texorpdfstring{smartdb.cubes.CubeStruct.getFieldProjection}{getFieldProjection}}
\begin{verbatim}
...
\end{verbatim}
\subsection{\texorpdfstring{smartdb.cubes.CubeStruct.getFieldTypeList}{getFieldTypeList}}
\begin{verbatim}
...
Output:
 regular:
  fieldTypeList: cell [1,nFields] of smartdb.cubes.ACubeStructFieldType[1,1]
      - list of field types
\end{verbatim}
\subsection{\texorpdfstring{smartdb.cubes.CubeStruct.getFieldTypeSpecList}{getFieldTypeSpecList}}
\begin{verbatim}
...
\end{verbatim}
\subsection{\texorpdfstring{smartdb.cubes.CubeStruct.getFieldValueSizeMat}{getFieldValueSizeMat}}
\begin{verbatim}
...
\end{verbatim}
\subsection{\texorpdfstring{smartdb.cubes.CubeStruct.getIsFieldValueNull}{getIsFieldValueNull}}
\begin{verbatim}
...
\end{verbatim}
\subsection{\texorpdfstring{smartdb.cubes.CubeStruct.getMinDimensionSize}{getMinDimensionSize}}
\begin{verbatim}
...
\end{verbatim}
\subsection{\texorpdfstring{smartdb.cubes.CubeStruct.getMinDimensionality}{getMinDimensionality}}
\begin{verbatim}
...
Output:
  minDimensionality: double[1,1] - minimum dimensionality of
     self object
\end{verbatim}
\subsection{\texorpdfstring{smartdb.cubes.CubeStruct.getNElems}{getNElems}}
\begin{verbatim}
...
\end{verbatim}
\subsection{\texorpdfstring{smartdb.cubes.CubeStruct.getNFields}{getNFields}}
\begin{verbatim}
...
\end{verbatim}
\subsection{\texorpdfstring{smartdb.cubes.CubeStruct.initByEmptyDataSet}{initByEmptyDataSet}}
\begin{verbatim}
...
\end{verbatim}
\subsection{\texorpdfstring{smartdb.cubes.CubeStruct.initByNullDataSet}{initByNullDataSet}}
\begin{verbatim}
...
Input:
  ...
  optional
      minDimVec: double[1,nDims] - size vector of null value arrays
\end{verbatim}
\subsection{\texorpdfstring{smartdb.cubes.CubeStruct.isEqual}{isEqual}}
\begin{verbatim}
...
Output:
  ...
  reportStr: char[1,] - contains an additional information about the
     differences (if any)
\end{verbatim}
\subsection{\texorpdfstring{smartdb.cubes.CubeStruct.isFields}{isFields}}
\begin{verbatim}
...
Output:
  ...
  reportStr: char[1,] - contains an additional information about the
     differences (if any)
\end{verbatim}
\subsection{\texorpdfstring{smartdb.cubes.CubeStruct.saveObj}{saveObj}}
\begin{verbatim}
...
\end{verbatim}
\subsection{\texorpdfstring{smartdb.cubes.CubeStruct.setField}{setField}}
\begin{verbatim}
...
\end{verbatim}
\subsection{\texorpdfstring{smartdb.cubes.CubeStruct.toArray}{toArray}}
\begin{verbatim}
...
Output:
  ...
  requested). In this case the last output argument is
       ...
       isConvertedToCell: logical[nFields,nStructs] -  matrix with true
          ...
          cells
\end{verbatim}
\subsection{\texorpdfstring{smartdb.cubes.CubeStruct.toStruct}{toStruct}}
\begin{verbatim}
