...
\newline
\verbmcodef[Installation]{mcodesnippets/chapter4_section1_snippet01.m}
...
\newline
\verbmcodef[Basic functionality]{mcodesnippets/chapter4_section1_snippet02.m}
\newline
...
Type
\newline
\verbmcodef[Plot ellypsoids and hyperplanes]{mcodesnippets/chapter4_section1_snippet03.m}
\newline
...
and verification]{mcodesnippets/chapter4_section1_snippet04.m}
\end{enumerate}
...
\verbmcodef[Definition of the ellipsoid]{mcodesnippets/chapter5_section1_snippet01.m}
...
For example,
\verbmcodef[Examples of the operation]{mcodesnippets/chapter5_section1_snippet02.m}
To access individual elements of the array, the usual MATLAB subindexing
is used:
\verbmcodef[Access to individual elements]{mcodesnippets/chapter5_section1_snippet03.m}
...
\verbmcodef[Modification of the ellipsoid's shape]{mcodesnippets/chapter5_section1_snippet04.m}
...
\verbmcodef[Get the center and the shape matrix of ellipsoid]{mcodesnippets/chapter5_section1_snippet05.m}
\verbmcodef[Check if given ellipsoids are degenerate]{mcodesnippets/chapter5_section1_snippet06.m}
\verbmcodef[Get space dimensions and ranks of the shape matrices]{mcodesnippets/chapter5_section1_snippet07.m}
One way to check if two ellipsoids intersect, is to compute
the distance between them:
\verbmcodef[Computation of the distance between ellipsoids]{mcodesnippets/chapter5_section1_snippet08.m}
...
from the inside:
\verbmcodef[Approximation of the ellipsoids' intersection]{mcodesnippets/chapter5_section1_snippet09.m}
...
\verbmcodef[Check if the ellipsoid contains the intersection]{mcodesnippets/chapter5_section1_snippet10.m}
\verbmcodef[Check if the internal approximation is contained in the intersection]{mcodesnippets/chapter5_section1_snippet11.m}
...
\verbmcodef[Check if the intersection of more than two ellipsoids is empty]{mcodesnippets/chapter5_section1_snippet12.m}
...
\verbmcodef[Check if ellipsoid intersects the ellipsoids' intersection]{mcodesnippets/chapter5_section1_snippet13.m}
\verbmcodef[Check if ellipsoid intersects the ellipsoids' union]{mcodesnippets/chapter5_section1_snippet14.m}
For the ellipsoids in ${\bf R}$, ${\bf R}^2$ and ${\bf R}^3$ the geometric
sum can be computed explicitely and plotted:
\verbmcodef[Compute and plot the geometric sum of ellipsoids]{mcodesnippets/chapter5_section1_snippet15.m}
...
\verbmcodef[Approximation of the geometric sum's result]{mcodesnippets/chapter5_section1_snippet16.m}
...
${\bf R}^2$ and ${\bf R}^3$:
\newpage
\verbmcodef[Geometric difference]{mcodesnippets/chapter5_section1_snippet17.m}
...
is not bad:
\verbmcodef[Approximation of the geometric difference's result]{mcodesnippets/chapter5_section1_snippet18.m}
...
\verbmcodef[Implementation of an operation 'difference-sum']{mcodesnippets/chapter5_section1_snippet19.m}
...
which is used for visualization and works for dimensions not higher than $3$,
whereas the last two can deal with ellipsoids of arbitrary dimension.
\verbmcodef[Implementation of an operation 'sum-difference']{mcodesnippets/chapter5_section1_snippet20.m}
...
\verbmcodef[Definition of the hyperplane]{mcodesnippets/chapter5_section1_snippet21.m}
...
object:
\verbmcodef[Get the normal and the scalar that define hyperplane H]{mcodesnippets/chapter5_section1_snippet22.m}
\verbmcodef[Get the dimension of the space where H is defined]{mcodesnippets/chapter5_section1_snippet23.m}
\verbmcodef[Check which of two hyperplanes in array H0 is parallel to H]{mcodesnippets/chapter5_section1_snippet24.m}
...
\verbmcodef[Convertation an array of hyperplanes to the {\tt polytope} object]{mcodesnippets/chapter5_section1_snippet25.m}
...
\verbmcodef[Computation of the distance from ellipsoids to hyperplanes and polytopes]{mcodesnippets/chapter5_section1_snippet26.m}
...
\verbmcodef[Check if the union of ellipsoids intersects  hyperplane]{mcodesnippets/chapter5_section1_snippet27.m}
\verbmcodef[Check if the intersection of ellipsoids intersects with
hyperplane]{mcodesnippets/chapter5_section1_snippet28.m}
\verbmcodef[Check if the intersection of ellipsoids intersects with polytope]{mcodesnippets/chapter5_section1_snippet29.m}



The intersection of ellipsoid and hyperplane can be computed exactly:
\verbmcodef[Computation of the intersection of ellipsoid and hyperplane]{mcodesnippets/chapter5_section1_snippet30.m}
...
{\tt polytope} objects:
\verbmcodef[Computation of external and internal ellipsoidal approximations]{mcodesnippets/chapter5_section1_snippet31.m}
...
{mcodesnippets/chapter5_section1_snippet32.m}

\verbmcodef[Check if the ellipsoid contains the intersection of polytopes]
{mcodesnippets/chapter5_section1_snippet33.m}
...
{mcodesnippets/chapter5_section2_snippet01.m}
...
{mcodesnippets/chapter5_section2_snippet02.m}
...
{mcodesnippets/chapter5_section2_snippet03.m}
...
{mcodesnippets/chapter5_section2_snippet04.m}
...
{mcodesnippets/chapter5_section2_snippet05.m}
...
{mcodesnippets/chapter5_section2_snippet06.m}
...
\verbmcodef[Extraction of the reach set approximation data]{mcodesnippets/chapter5_section2_snippet07.m}
...
\verbmcodef[Get the reachability data in the time interval]{mcodesnippets/chapter5_section2_snippet08.m}

To obtain a snap shot of the reach set at given time, the same function
{\tt cut} is used:
\verbmcodef[Obtaining of the snap shot at given time]{mcodesnippets/chapter5_section2_snippet09.m}
...
\verbmcodef[Check if ellipsoid intersects with external approximation]{mcodesnippets/chapter5_section2_snippet10.m}
\verbmcodef[Check if ellipsoid intersects with internal approximation]{mcodesnippets/chapter5_section2_snippet11.m}
\verbmcodef[Check if hyperplanes intersect with internal approximation]{mcodesnippets/chapter5_section2_snippet12.m}
\verbmcodef[Check if polytope intersects with external approximation]{mcodesnippets/chapter5_section2_snippet13.m}
...
\verbmcodef[Check if the ellipsoid intersects the internal approximation]{mcodesnippets/chapter5_section2_snippet14.m}
...
of the reach set and the good curves]{mcodesnippets/chapter5_section2_snippet15.m}
...
\verbmcodef[Computation of the further evolution in time of the reach set]{mcodesnippets/chapter5_section2_snippet16.m}
...
\verbmcodef[Computation of the backward reach set]{mcodesnippets/chapter5_section2_snippet17.m}
...
{mcodesnippets/chapter5_section2_snippet18.m}
...
{mcodesnippets/chapter5_section3_snippet01.m}
...
{mcodesnippets/chapter5_section3_snippet02.m}
...
{mcodesnippets/chapter6_section1_snippet01.m}
...
{mcodesnippets/chapter6_section1_snippet02.m}
...
{mcodesnippets/chapter6_section4_snippet01.m}
...
{mcodesnippets/chapter7_section1_snippet01.m}
...
{mcodesnippets/chapter7_section2_snippet01.m}
...
{mcodesnippets/chapter7_section2_snippet02.m}
...
{mcodesnippets/chapter7_section3_snippet01.m}
...
{mcodesnippets/chapter7_section3_snippet02.m}
...
{mcodesnippets/chapter7_section4_snippet01.m}
...
ellipsoid]{mcodesnippets/chapter7_section4_snippet02.m}
...
intersect the guard.
\verbmcodef[Determination of  the  ellipsoids as an array that intersect the guard]{mcodesnippets/chapter7_section4_snippet03.m}
...
\verbmcodef[The union of reach sets in array]{mcodesnippets/chapter7_section4_snippet04.m}
...
\verbmcodef[Example]{mcodesnippets/appendixA_section1_snippet01.m}
...
\verbmcodef[Example]{mcodesnippets/appendixA_section1_snippet02.m}
...
\end{itemize}
\verbmcodef[Example]{mcodesnippets/appendixA_section1_snippet03.m}
...
\verbmcodef[Example]{mcodesnippets/appendixA_section1_snippet04.m}
...
\verbmcodef[Example]{mcodesnippets/appendixA_section1_snippet05.m}
...
\verbmcodef[Example]{mcodesnippets/appendixA_section1_snippet06.m}
...
\verbmcodef[Example]{mcodesnippets/appendixA_section1_snippet07.m}
...
\verbmcodef[Example]{mcodesnippets/appendixA_section1_snippet08.m}
...
\verbmcodef[Example]{mcodesnippets/appendixA_section1_snippet09.m}
...
\verbmcodef[Example]{mcodesnippets/appendixA_section1_snippet10.m}
...
\verbmcodef[Example]{mcodesnippets/appendixA_section1_snippet11.m}
...
\verbmcodef[Example]{mcodesnippets/appendixA_section1_snippet12.m}
...
\verbmcodef[Example]{mcodesnippets/appendixA_section1_snippet13.m}
...
\verbmcodef[Example]{mcodesnippets/appendixA_section1_snippet14.m}
...
\verbmcodef[Example]{mcodesnippets/appendixA_section1_snippet15.m}
...
\verbmcodef[Example]{mcodesnippets/appendixA_section1_snippet16.m}
...
\verbmcodef[Example]{mcodesnippets/appendixA_section1_snippet17.m}
...
\verbmcodef[Example]{mcodesnippets/appendixA_section1_snippet18.m}
...
\verbmcodef[Example]{mcodesnippets/appendixA_section1_snippet19.m}
...
\verbmcodef[Example]{mcodesnippets/appendixA_section1_snippet20.m}
...
\verbmcodef[Example]{mcodesnippets/appendixA_section1_snippet21.m}
...
\verbmcodef[Example]{mcodesnippets/appendixA_section1_snippet22.m}
...
\verbmcodef[Example]{mcodesnippets/appendixA_section1_snippet23.m}
...
\verbmcodef[Example]{mcodesnippets/appendixA_section1_snippet24.m}
...
\verbmcodef[Example]{mcodesnippets/appendixA_section1_snippet25.m}
...
ellipsoid.
\verbmcodef[Example]{mcodesnippets/appendixA_section1_snippet26.m}
...
\end{itemize}
\verbmcodef[Example]{mcodesnippets/appendixA_section1_snippet27.m}
...
\verbmcodef[Example]{mcodesnippets/appendixA_section1_snippet28.m}
...
\verbmcodef[Example]{mcodesnippets/appendixA_section1_snippet29.m}
...
\verbmcodef[Example]{mcodesnippets/appendixA_section1_snippet30.m}
...
\verbmcodef[Example]{mcodesnippets/appendixA_section1_snippet31.m}
...
\verbmcodef[Example]{mcodesnippets/appendixA_section2_snippet01.m}
...
\verbmcodef[Example]{mcodesnippets/appendixA_section2_snippet02.m}
...
\verbmcodef[Example]{mcodesnippets/appendixA_section2_snippet03.m}
...
\verbmcodef[Example]{mcodesnippets/appendixA_section2_snippet04.m}
...
\verbmcodef[Example]{mcodesnippets/appendixA_section2_snippet05.m}
...
\verbmcodef[Example]{mcodesnippets/appendixA_section2_snippet06.m}
...
\verbmcodef[Example]{mcodesnippets/appendixA_section2_snippet07.m}
...
\verbmcodef[Example]{mcodesnippets/appendixA_section3_snippet01.m}
