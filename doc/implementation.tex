...
\todo[inline]{Updated all methods' callings according to the the new OOP}
...
for the discrete-time system description and classes {\tt ReachContinious$\backslash$ReachDiscrete} for the reach set data. We start by explaining how to define a system
...
{mcodesnippets/s_chapter05_section03_snippet03.m}
...
{mcodesnippets/s_chapter05_section03_snippet04.m}
...
{mcodesnippets/s_chapter05_section03_snippet05.m}
...
{mcodesnippets/s_chapter05_section03_snippet06.m}
...
\verbmcodef[Extraction of the reach set approximation data]{mcodesnippets/s_chapter05_section03_snippet07.m}
...
This data can be extracted and returned in the form of {\tt ReachContinious}
object by the {\tt cut} function:
\verbmcodef[Get the reachability data in the time interval]{mcodesnippets/s_chapter05_section03_snippet08.m}

To obtain a snap shot of the reach set at given time, the same function
{\tt cut} is used:
\verbmcodef[Obtaining of the snap shot at given time]{mcodesnippets/s_chapter05_section03_snippet09.m}
...
\verbmcodef[Check if ellipsoid intersects with external approximation]{mcodesnippets/s_chapter05_section03_snippet10.m}
\verbmcodef[Check if ellipsoid intersects with internal approximation]{mcodesnippets/s_chapter05_section03_snippet11.m}
\verbmcodef[Check if hyperplanes intersect with internal approximation]{mcodesnippets/s_chapter05_section03_snippet12.m}
\verbmcodef[Check if polytope intersects with external approximation]{mcodesnippets/s_chapter05_section03_snippet13.m}
...
\verbmcodef[Check if the ellipsoid intersects the internal approximation]{mcodesnippets/s_chapter05_section03_snippet14.m}
...
Having a reach set object resulting from the {\tt ReachContinious}, {\tt cut} or
...
of the reach set and the good curves]{mcodesnippets/s_chapter05_section03_snippet15.m}
...
\verbmcodef[Computation of the further evolution in time of the reach set]{mcodesnippets/s_chapter05_section03_snippet16.m}
...
\verbmcodef[Computation of the backward reach set]{mcodesnippets/s_chapter05_section03_snippet17.m}
...
{mcodesnippets/s_chapter05_section03_snippet18.m}
...
Function {\tt projection} exists also for the {\tt ReachContinious$\backslash$ReachDiscrete} objects:
