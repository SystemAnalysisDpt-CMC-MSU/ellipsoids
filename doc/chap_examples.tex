...
\easyfigure[ht][0.7\textwidth]{chapter06_section01_ellpoly.png}{Reach set computation performance comparison}{ellpolyfig}
...
\end{eqnarray}
\easyfigure[ht][0.6\textwidth]{chapter06_section02_springmass.png}{Spring-mass system.}{springmassfig}
...
$t=4$.
\easyfigure[ht][0.8\textwidth]{chapter06_section02_reachmech.png}{Spring-mass system without disturbance:
...
\end{itemize}
\easyfigure[ht][0.6\textwidth]{chapter06_section03_rlc.png}{RLC circuit with two inputs.}{rlcfig}
...
\easyfigure[ht][0.7\textwidth]{chapter06_section03_rlcreach.png}{Forward and backward reach sets of the switched system
...
\easyfigure[ht][0.6\textwidth]{chapter06_section04_hw.png}{Highway model. Adapted from \cite{MUNOZ_SUN_HOROWITZ_ALVAREZ_DENSITY_ESTIMATION_WITH_THE_CELL_MODEL}.}{hwfig}
...
\easyfigure[ht][0.8\textwidth]{chapter06_section04_hwreach.png}{Reach set of the free-flow system is blue, reach set of the congested
