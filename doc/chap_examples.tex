...
\easyfigure[h][10cm]{ellpoly.eps}{Reach set computation performance comparison}{ellpolyfig}
...
\end{eqnarray}
\easyfigure[h][10cm]{springmass.eps}{Spring-mass system.}{springmassfig}
...
$t=4$.
\easyfigure[h][10 cm]{reachmech.eps}{Spring-mass system without disturbance:
...
\end{itemize}
\easyfigure[h][10cm]{rlc.eps}{RLC circuit with two inputs.}{rlcfig}
...
\easyfigure[h][10 cm]{rlcreach.eps}{Forward and backward reach sets of the switched system
...
\easyfigure[h][10cm]{hw.eps}{Highway model. Adapted from \cite{xiaotian}.}{hwfig}
...
\easyfigure[h][10cm]{hwreach.eps}{Reach set of the free-flow system is blue, reach set of the congested
