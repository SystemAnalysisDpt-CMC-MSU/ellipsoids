...
\easyfigure[h][0.7\textwidth]{ellpoly.eps}{Reach set computation performance comparison}{ellpolyfig}
...
\end{eqnarray}
\easyfigure[h][0.6\textwidth]{springmass.eps}{Spring-mass system.}{springmassfig}
...
$t=4$.
\easyfigure[h][0.8\textwidth]{reachmech.eps}{Spring-mass system without disturbance:
...
\end{itemize}
\easyfigure[h][0.6\textwidth]{rlc.eps}{RLC circuit with two inputs.}{rlcfig}
...
\easyfigure[h][0.7\textwidth]{rlcreach.eps}{Forward and backward reach sets of the switched system
...
\easyfigure[h][0.6\textwidth]{hw.eps}{Highway model. Adapted from \cite{MUNOZ_SUN_HOROWITZ_ALVAREZ_DENSITY_ESTIMATION_WITH_THE_CELL_MODEL}.}{hwfig}
...
\easyfigure[h][0.8\textwidth]{hwreach.eps}{Reach set of the free-flow system is blue, reach set of the congested
