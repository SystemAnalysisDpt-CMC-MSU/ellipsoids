...
\verbmcodef[Definition of the ellipsoid]{../products/+elltool/+doc/+snip/s_chapter05_section01_snippet01.m}
...
For example,
\verbmcodef[Examples of the operation]{../products/+elltool/+doc/+snip/s_chapter05_section01_snippet02.m}
To access individual elements of the array, the usual MATLAB subindexing
is used:
\verbmcodef[Access to individual elements]{../products/+elltool/+doc/+snip/s_chapter05_section01_snippet03.m}
...
\verbmcodef[Modification of the ellipsoid's shape]{../products/+elltool/+doc/+snip/s_chapter05_section01_snippet04.m}
...
\verbmcodef[Get the center and the shape matrix of ellipsoid]{../products/+elltool/+doc/+snip/s_chapter05_section01_snippet05.m}
\verbmcodef[Check if given ellipsoids are degenerate]{../products/+elltool/+doc/+snip/s_chapter05_section01_snippet06.m}
\verbmcodef[Get space dimensions and ranks of the shape matrices]{../products/+elltool/+doc/+snip/s_chapter05_section01_snippet07.m}
...
\verbmcodef[Computation of the distance between ellipsoids]{../products/+elltool/+doc/+snip/s_chapter05_section01_snippet08.m}
...
\verbmcodef[Approximation of the ellipsoids' intersection]{../products/+elltool/+doc/+snip/s_chapter05_section01_snippet09.m}
...
\verbmcodef[Check if the ellipsoid contains the intersection]{../products/+elltool/+doc/+snip/s_chapter05_section01_snippet10.m}
\verbmcodef[Check if the internal approximation is contained in the intersection]{../products/+elltool/+doc/+snip/s_chapter05_section01_snippet11.m}
...
\verbmcodef[Check if the intersection of more than two ellipsoids is empty]{../products/+elltool/+doc/+snip/s_chapter05_section01_snippet12.m}
...
\verbmcodef[Check if ellipsoid intersects the ellipsoids' intersection]{../products/+elltool/+doc/+snip/s_chapter05_section01_snippet13.m}
\verbmcodef[Check if ellipsoid intersects the ellipsoids' union]{../products/+elltool/+doc/+snip/s_chapter05_section01_snippet14.m}
For the ellipsoids in ${\bf R}$, ${\bf R}^2$ and ${\bf R}^3$ the geometric
sum can be computed explicitely and plotted:
\verbmcodef[Compute and plot the geometric sum of ellipsoids]{../products/+elltool/+doc/+snip/s_chapter05_section01_snippet15.m}
...
\verbmcodef[Approximation of the geometric sum's result]{../products/+elltool/+doc/+snip/s_chapter05_section01_snippet16.m}
\easyfigure[ht][0.6\textwidth]{chapter05_section01_minksum.png}{The geometric sum of ellipsoids}{minksumPic}
...
${\bf R}^2$ and ${\bf R}^3$:
\verbmcodef[Geometric difference]{../products/+elltool/+doc/+snip/s_chapter05_section01_snippet17.m}
\easyfigure[ht][0.6\textwidth]{chapter05_section01_minkdiff.png}{The geometric difference of ellipsoids}{minkdiffPic}
...
is not bad:
\verbmcodef[Approximation of the geometric difference's result]{../products/+elltool/+doc/+snip/s_chapter05_section01_snippet18.m}
...
\verbmcodef[Implementation of an operation 'difference-sum']{../products/+elltool/+doc/+snip/s_chapter05_section01_snippet19.m}
\easytwofigures{chapter05_section01_minkpm.png}{Implementation of an operation 'sum-difference'}{minkpmPic}{chapter05_section01_minkmp.png}{Implementation of an operation 'difference-sum'}{minkmpPic}{Implementation of the {\tt minkpm}, {\tt minkmp} operations}{minkPic}
...
\verbmcodef[Implementation of an operation 'sum-difference']{../products/+elltool/+doc/+snip/s_chapter05_section01_snippet20.m}
...
\verbmcodef[Definition of the hyperplane]{../products/+elltool/+doc/+snip/s_chapter05_section02_snippet01.m}
...
object:
\verbmcodef[Get the normal and the scalar that define hyperplane hypObj]{../products/+elltool/+doc/+snip/s_chapter05_section02_snippet02.m}
\verbmcodef[Get the dimension of the space where hypObj is defined]{../products/+elltool/+doc/+snip/s_chapter05_section02_snippet03.m}
\verbmcodef[Hyperplanes' check for parallelism]{../products/+elltool/+doc/+snip/s_chapter05_section02_snippet04.m}
...
\verbmcodef[Convertation an array of hyperplanes to the {\tt polytope} object]{../products/+elltool/+doc/+snip/s_chapter05_section02_snippet05.m}
...
\verbmcodef[Computation of the distance from ellipsoids to hyperplanes and polytopes]{../products/+elltool/+doc/+snip/s_chapter05_section02_snippet06.m}
...
\verbmcodef[Check if the union of ellipsoids intersects  hyperplane]{../products/+elltool/+doc/+snip/s_chapter05_section02_snippet07.m}
\verbmcodef[Check if the intersection of ellipsoids intersects with
hyperplane]{../products/+elltool/+doc/+snip/s_chapter05_section02_snippet08.m}
\verbmcodef[Check if the intersection of ellipsoids intersects with polytope]{../products/+elltool/+doc/+snip/s_chapter05_section02_snippet09.m}



The intersection of ellipsoid and hyperplane can be computed exactly:
\verbmcodef[Computation of the intersection of ellipsoid and hyperplane]{../products/+elltool/+doc/+snip/s_chapter05_section02_snippet10.m}
...
{\tt polytope} objects:
\verbmcodef[Computation of external and internal ellipsoidal approximations]{../products/+elltool/+doc/+snip/s_chapter05_section02_snippet11.m}
...
{../products/+elltool/+doc/+snip/s_chapter05_section02_snippet12.m}

\verbmcodef[Check if the ellipsoid contains the intersection of polytopes]
{../products/+elltool/+doc/+snip/s_chapter05_section02_snippet13.m}
...
\verbmcodef[Constructing the ellipsoidal tube from arrays]{../products/+elltool/+doc/+snip/s_chapter05_section03_snippet01.m}
\verbmcodef[Constructing the ellipsoidal tube from ellipsoids]{../products/+elltool/+doc/+snip/s_chapter05_section03_snippet02.m}
...
\verbmcodef[Get the ellipsoidal tube in the time interval]{../products/+elltool/+doc/+snip/s_chapter05_section03_snippet03.m}
We can compute the projection of the ellipsoidal tube onto time-dependent subspace.
\verbmcodef[Computing the projection of the ellipsoidal tube]{../products/+elltool/+doc/+snip/s_chapter05_section03_snippet04.m}

\easytwofigures{chapter05_section03_reachTubeStatProj.png}{Static projection of the ellipsoidal tube}{stat_proj}{chapter05_section03_reachTubeDynProj.png}{Dynamic projection of the ellipsoidal tube.}{dyn_proj}{Projection of the ellipsoidal tube.}{project}
...
\verbmcodef[Computing the tubes by the instant of time]{../products/+elltool/+doc/+snip/s_chapter05_section03_snippet05.m}
\easyfigure[ht][0.6\textwidth]{chapter05_section03_unionTubeStatProj.png}{Ellipsoidal tubes by the instant of time}{unionTubeStatProj}
...
\verbmcodef[Getting the initial ellipsoidal array]{../products/+elltool/+doc/+snip/s_chapter05_section03_snippet06.m}
There is a method to display a content of ellipsoidal tubes.
\verbmcodef[Display a content of the ellipsoidal tube]{../products/+elltool/+doc/+snip/s_chapter05_section03_snippet07.m}
\easyfigure[ht][0.8\textwidth]{chapter05_section03_dispPic.png}{Content of the ellipsoidal tube}{dispPic}
...
\verbmcodef[Filtering of the tube by 'sTime' parameter]{../products/+elltool/+doc/+snip/s_chapter05_section03_snippet08.m}
Also you can use the method {\tt display} to see the result of the method's work.
\verbmcodef[Selection of the tube by index]{../products/+elltool/+doc/+snip/s_chapter05_section03_snippet09.m}
We can sort our tubes by certain fields:
\verbmcodef[Sorting of the tubes]{../products/+elltool/+doc/+snip/s_chapter05_section03_snippet10.m}
...
{../products/+elltool/+doc/+snip/s_chapter05_section04_snippet01.m}
...
{../products/+elltool/+doc/+snip/s_chapter05_section04_snippet02.m}
...
{../products/+elltool/+doc/+snip/s_chapter05_section04_snippet03.m}
...
{../products/+elltool/+doc/+snip/s_chapter05_section04_snippet04.m}
...
{../products/+elltool/+doc/+snip/s_chapter05_section04_snippet05.m}
...
{../products/+elltool/+doc/+snip/s_chapter05_section04_snippet06.m}
...
\verbmcodef[Extraction of the reach set approximation data]{../products/+elltool/+doc/+snip/s_chapter05_section04_snippet07.m}
...
\verbmcodef[Get the reachability data in the time interval]{../products/+elltool/+doc/+snip/s_chapter05_section04_snippet08.m}

To obtain a snap shot of the reach set at given time, the same function
{\tt cut} is used:
\verbmcodef[Obtaining of the snap shot at given time]{../products/+elltool/+doc/+snip/s_chapter05_section04_snippet09.m}
...
\verbmcodef[Check if ellipsoid intersects with external approximation]{../products/+elltool/+doc/+snip/s_chapter05_section04_snippet10.m}
\verbmcodef[Check if ellipsoid intersects with internal approximation]{../products/+elltool/+doc/+snip/s_chapter05_section04_snippet11.m}
\verbmcodef[Check if hyperplanes intersect with internal approximation]{../products/+elltool/+doc/+snip/s_chapter05_section04_snippet12.m}
\verbmcodef[Check if polytope intersects with external approximation]{../products/+elltool/+doc/+snip/s_chapter05_section04_snippet13.m}
...
\verbmcodef[Check if the ellipsoid intersects the internal approximation]{../products/+elltool/+doc/+snip/s_chapter05_section04_snippet14.m}
...
of the reach set and the good curves]{../products/+elltool/+doc/+snip/s_chapter05_section04_snippet15.m}
...
\verbmcodef[Computation of the further evolution in time of the reach set]{../products/+elltool/+doc/+snip/s_chapter05_section04_snippet16.m}
...
\verbmcodef[Computation of the backward reach set]{../products/+elltool/+doc/+snip/s_chapter05_section04_snippet17.m}
...
{../products/+elltool/+doc/+snip/s_chapter05_section04_snippet18.m}
...
{../products/+elltool/+doc/+snip/s_chapter05_section05_snippet01.m}
...
{../products/+elltool/+doc/+snip/s_chapter05_section05_snippet02.m}
 Some of the parameters can be changed
in run-time via setters.
\verbmcodef[Changing parameters]
{../products/+elltool/+doc/+snip/s_chapter05_section05_snippet03.m}
...
{../products/+elltool/+doc/+snip/s_chapter05_section06_snippet01.m}
...
{../products/+elltool/+doc/+snip/s_chapter05_section06_snippet02.m}
