...
\begin{figure}[htbp]
\centerline{
\includegraphics[height=8 cm]{firstProj.eps}}
\caption{Projection of the ellipsoidal tube.}
\label{ellpolyfig}
\end{figure}
Union of the tubes can be computed by method {\tt fromEllTubes}
\verbmcodef[Computing of the tubes' union]{mcodesnippets/s_chapter05_section03_snippet05.m}
...
Also we can sort our tubes by certain fields:
