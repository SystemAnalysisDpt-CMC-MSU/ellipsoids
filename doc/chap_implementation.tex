...
The class {\tt gras.ellapx.smartdb.rels.EllTube} of the {\it Ellipsoidal Toolbox} is used
to describe ellipsoidal tubes.
\verbmcodef[Definitions of the ellipsoidal tube]{mcodesnippets/s_chapter05_section07_snippet01.m}
We can get a description of the tube using the following commands:
\verbmcodef[Description of the ellipsoidal tube]{mcodesnippets/s_chapter05_section07_snippet02.m}
...
computed, say $20\leq t\leq80$.
This data can be extracted  by the {\tt cut} function:
\verbmcodef[Get the ellipsoidal tube in the time interval]{mcodesnippets/s_chapter05_section07_snippet03.m}
The class {\tt gras.ellapx.smartdb.rels.EllUnionTube} is used
to describe the union of the ellipsoidal tubes.

The class {\tt gras.ellapx.smartdb.rels.EllTubeProj} is used
to describe the projection of the ellipsoidal tubes.

The class {\tt gras.ellapx.smartdb.rels.EllUnionTubeStaticProj} is used
to determine a projection on static plane of the ellipsoid tubes union.
