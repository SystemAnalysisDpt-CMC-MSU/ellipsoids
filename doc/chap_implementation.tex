...
the distance between them (\cite{Chan}, \cite{LinHan}):
...
from the inside. See $\cite{RosSabaterThomas}$ for more information about these methods.
...
\easyfigure[h][12cm]{unionTubeStatProj.eps}{Ellipsoidal tubes by the instant of time}{unionTubeStatProj}
...
\easyfigure[h][12cm]{dispPic.eps}{Content of the ellipsoidal tube}{dispPic}
