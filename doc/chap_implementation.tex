...
\easyfigure[h][0.6\textwidth]{minksum.eps}{The geometric sum of ellipsoids}{minksumPic}
...
\easyfigure[h][0.6\textwidth]{minkdiff.eps}{The geometric difference of ellipsoids}{minkdiffPic}
...
\easyfigure[h][0.6\textwidth]{unionTubeStatProj.eps}{Ellipsoidal tubes by the instant of time}{unionTubeStatProj}
...
\easyfigure[h][0.8\textwidth]{dispPic.eps}{Content of the ellipsoidal tube}{dispPic}
