 classdef ATestDynGettersBaseTestCase < mlunitext.test_case
    ...
    methods (Abstract, Access = protected)
        bpbMat = bpbFunc(pDynBPBMat,probDynObj,curTime)
    end
    
    methods
        function self = ATestDynGettersBaseTestCase(varargin)
    ...
    methods 
       function isOk = testBaseTestDynGetters(self)
            isOk=true;
            CMP_TOL=1e-10;
