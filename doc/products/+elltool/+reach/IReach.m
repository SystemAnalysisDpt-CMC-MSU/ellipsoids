...
%
    methods (Abstract)
        ...
        %       {1x1 cell}    {1x2 cell}
        %
        intProbDynList = getIntProbDynamicsList(self)
        %
        ...
        %       {1x1 cell}    {1x2 cell}
        %
        goodDirSetList = getGoodDirSetList(self)
        %
        ...
        %       {1x1 cell}    {1x2 cell}
        %
        extProbDynList = getExtProbDynamicsList(self)
        %
