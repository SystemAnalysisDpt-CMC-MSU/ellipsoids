...
% MODIFYCOPYRIGHT inserts a copyright statement into a line in
% help header. The line is identified based on a presence of
% the specified marker. Also the function removes all the lines that follow
% the newly inserted help header and contain the same marker
%
% Input:
%   regular:
...
map=containers.Map(...
    {'heartofmars@gmail.com',...
    'kirill.mayantsev@gmail.com',...
    'irizka91@gmail.com'},...
    {'Peter Gagarinov <pgagarinov@gmail.com>',...
    'Kirill Mayantsev  <kirill.myantsev@gmail.com>',...
    'Irizna Zukova  <irizka91@gmail.com>'});
try
    name=map(nickName);
catch meObj
