    ...
    methods
        ...
        function self = test_emaillogger_fail(self)
            obj=modgen.logging.EmailLogger(...
                ...
                'subjectSuffix','for something',...
                'loggerName','Test',...
                'isThrowExceptions',true);
            commandStr='obj.sendMessage(''calculation started'',''calculation started'')';
        ...
        function self = test_emaillogger_preferences(self)
            ...
            outputText = evalc( 'logger.sendMessage(''calculation started'',''calculation started'')' );
            ...
            logger=modgen.logging.EmailLogger(...
                ...
                'subjectSuffix','for something on blue1',...
