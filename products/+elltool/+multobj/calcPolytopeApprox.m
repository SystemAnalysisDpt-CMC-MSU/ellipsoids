...
%        coeffVec: double [1, nProjElems] - coefficients for each projection variable that are multiplied on the value of variable when dialogue with the graphics system ( по поводу этого параметра я задала Наталии вопрос, жду ответа)
%   optional:
