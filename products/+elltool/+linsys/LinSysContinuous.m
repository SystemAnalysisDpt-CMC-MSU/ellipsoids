classdef LinSysContinuous < elltool.linsys.ALinSys
    ...
    %  isempty           - Checks if the linear system object is 
    %                      empty.
    %  islti             - Returns 1 if the system is time-
    %                      invariant, 0 - otherwise.
    %  hasdisturbance    - Returns 1 if unknown bounded 
    %                      disturbance is present, 0 - if there  
    %                      is no disturbance, or disturbance 
    %                      vector is fixed.
    %  hasnoise          - Returns 1 if unknown bounded noise at 
    %                      the output is present, 0 - if there is 
    %                      no noise, or noise vector is fixed.
