classdef LinSysTestCase < mlunitext.test_case
    ...
    methods
        ...
        function self = testDisturbance(self)
            ...
            systemMat = [...
                elltool.linsys.LinSysFactory.create([],[],[]),...
                elltool.linsys.LinSysFactory.create(aMat,bMat,uEllipsoid,gMat,vVec),...
                elltool.linsys.LinSysFactory.create(aMat,bMat,uEllipsoid,gMat,vCVec);...
                elltool.linsys.LinSysFactory.create(aMat,bMat,uEllipsoid,gMat,vEllipsoid),...
                elltool.linsys.LinSysFactory.create(aMat,bMat,uEllipsoid,gMat,vEllStuct),...
                elltool.linsys.LinSysFactory.create(aMat,bMat,uEllipsoid,[],vEllStuct)...
            ];
            obtainedMat = systemMat.hasdisturbance();
