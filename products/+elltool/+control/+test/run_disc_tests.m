...
% Example:
%
%   elltool.control.test.run_disc_tests('filter',{'rot2dAnull',...
%       'elltool.control.test.mlunit.ReachDiscTC','testReachControl'})
%
%   elltool.control.test.run_disc_tests({'rot2d','rot2dAnull'},...
%       'filter',{'.*',...
%       'elltool.control.test.mlunit.ReachDiscTC','testReachControl'})
%
%   elltool.control.test.run_disc_tests('nParallelProcesses',12,...
%       'reCache',true,'filter',{'.*',...
%       'elltool.control.test.mlunit.ReachDiscTC','testReachControl'})
%
%   elltool.control.test.run_disc_tests('filter',{'_IsBackTrueIsEvolveFalse',...
%       '.*','testReachControl'})
%
