classdef DiscreteControlBuilder
    ...
    methods        
        function self = DiscreteControlBuilder(reachDiscObj)
            % DISCRETECONTROLBUILDER is a main class for building control
            % synthesis for continuous time systems. The class acts like a
            % control factory
            %
            % Input:
            %   regular:
            %       reachDIscObj: elltool.reach.ReachContinuous[1,1] - an
            %           object containing reachability tube ellipsoidal
            %           approximations for some discrete time system. It
            ...
            isBackward = reachDiscObj.isbackward();
            if (~isBackward)
        ...
        function controlFuncObj = getControlObj(self,x0Vec)
            ...
            %
            % Output:
            %   controlFuncObj: elltool.control.DiscSingleTubeControl[1,1]
            ...
            %
            controlFuncObj = elltool.control.DiscSingleTubeControl(...
