classdef GenEllipsoidDispStructTC < ...
    ...
    methods (Access = protected)
        ...
        function SArrCVec = getToStructStruct(self)
            SArrCVec = {struct('diagMat', eye(2), 'eigvMat', eye(2), ...
                'centerVec', [1, 1]'),...
                struct('diagMat', [], 'eigvMat', [], 'centerVec', []),...
                struct('diagMat', [], 'eigvMat', [], 'centerVec', []),...
                struct('diagMat', eye(2), 'eigvMat', eye(2), ...
                'centerVec', [1, 1]',...
        ...
        function isPropCVec = getToStructIsPropIncluded(self)
            isPropCVec = {false, false, false, true, false, false};
        end
        
        function isResultCVec = getToStructResult(self)
            isResultCVec = {true, true, false, true, false, false};
        end
        ...
        function objArrCVec = getDisplayObj(self)
            objArrCVec = {self.createEll([1, 1]', eye(2)),...
                ...
                self.createEll.fromStruct(struct('shapeMat',...%wtf?
                num2cell(ones(5, 5, 5)), ...
                'centerVec', num2cell(ones(5, 5, 5)))),...
        ...
        function objArrCVec = getEqSndObj(self)
            objArrCVec = {self.createEll([1, 1]', eye(2)),...
                ...
                self.createEll([1, 2]', eye(2)),...
                self.createEll([1, 1]', eye(2)),...
                self.createEll.fromStruct(struct('shapeMat',...%wff?
                num2cell(ones(5, 5, 5)), ...
                'centerVec', num2cell(ones(5, 5, 5)))),...
                self.createEll.fromStruct(struct('shapeMat',...
                num2cell(ones(5, 5, 5)), ...
