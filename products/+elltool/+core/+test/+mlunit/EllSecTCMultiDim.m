...
%            System Analysis Department 2012 $
    ...
    function self = testIsInside(self)
        ...
        function self = testMinkmp_ea(self)
            ...
            testError(12);
            testError(13);
            [test1EllArray, testDoubleArray, errorStr, testEll] = ...
                createTypicalArray(14);
            self.runAndCheckError...
                ('test1EllArray.minkmp_ea(testEll, test1EllArray, testDoubleArray)', ...
                errorStr);
            self.runAndCheckError...
                ('test1EllArray.minkmp_ea(testEll, test1EllArray, errorStr)', ...
                errorStr);
        ...
        function self = testMinkmp_ia(self)
            ...
            [test1EllArray, testDoubleArray, errorStr, testEll] = ...
                createTypicalArray(14);
            self.runAndCheckError...
                ('test1EllArray.minkmp_ia(testEll, test1EllArray, testDoubleArray)', ...
                errorStr);
            self.runAndCheckError...
                ('test1EllArray.minkmp_ia(testEll, test1EllArray, errorStr)', ...
                errorStr);
            function testCorrect(isnHighDim, flag)
                if (isnHighDim)
                    if (flag == 2)
        ...
        function self = testMinksum_ea(self)
            ...
            testError(12);
            testError(13);
            [test1EllArray, testDoubleArray, errorStr, ~] = ...
                createTypicalArray(14);
            self.runAndCheckError...
                ('test1EllArray.minksum_ea(testDoubleArray)', ...
                errorStr);
            self.runAndCheckError...
                ('test1EllArray.minksum_ea(errorStr)', ...
                errorStr);
            function testCorrect(isnHighDim, flag)
                if (isnHighDim)
        ...
        function self = testMinksum_ia(self)
            ...
            [test1EllArray, testDoubleArray, errorStr, ~] = ...
                createTypicalArray(14);
            self.runAndCheckError...
                ('test1EllArray.minksum_ia(testDoubleArray)', ...
                errorStr);
            self.runAndCheckError...
                ('test1EllArray.minksum_ia(errorStr)', ...
                errorStr);
            function testCorrect(isnHighDim, flag)
                if (isnHighDim)
                    [myEllArray, myMat, ansEllVec] = ...
        ...
        function self = testMinkpm_ea(self)
            ...
            [test1EllArray, testDoubleArray, errorStr, testEll] = ...
                createTypicalArray(14);
            self.runAndCheckError...
                ('test1EllArray.minkpm_ea(testEll, testDoubleArray)', ...
                errorStr);
            self.runAndCheckError...
                ('test1EllArray.minkpm_ea(testEll, errorStr)', ...
                errorStr);
        ...
        function self = testMinkpm_ia(self)
            ...
            [test1EllArray, testDoubleArray, errorStr, testEll] = ...
                createTypicalArray(14);
            self.runAndCheckError...
                ('test1EllArray.minkpm_ia(testEll, testDoubleArray)', ...
                errorStr);
            self.runAndCheckError...
                ('test1EllArray.minkpm_ia(testEll, errorStr)', ...
                errorStr);
            function testCorrect(isnHighDim, flag)
                if (isnHighDim)
                    if (flag == 8)
...
function [varargout] = createTypicalArray(flag)
    switch flag
        ...
        case 13
            ...
            varargout{3} = errorStr;
        case 14
            arraySizeVec = [1, 1, 1, 3, 1, 3, 1];
            myEll = ell_unitball(3);
            my2Ell = ell_unitball(3);
            testEllArray = createObjectArray(arraySizeVec, @ell_unitball, ...
                3, 1, 1);
            testDoubleArray = ones(3, 3, 3);
            errorStr = 'wrongInput';
            varargout{1} = testEllArray;
            varargout{2} = testDoubleArray;
            varargout{3} = errorStr;
            varargout{4} = myEll;
            varargout{5} = my2Ell;
        otherwise
