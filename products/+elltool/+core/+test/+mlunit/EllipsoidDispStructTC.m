    ...
    methods (Access = protected, Static)
        function objArrCVec = getToStructObj()
            objArrCVec = {elltool.core.test.mlunit.EllipsoidDispStructTC.ellipsoid([1, 1]', eye(2)),...
                elltool.core.test.mlunit.EllipsoidDispStructTC.ellipsoid(),...
                elltool.core.test.mlunit.EllipsoidDispStructTC.ellipsoid([1, 1]', eye(2)),...
                elltool.core.test.mlunit.EllipsoidDispStructTC.ellipsoid([1, 1]', eye(2)),...
                elltool.core.test.mlunit.EllipsoidDispStructTC.ellipsoid([1, 1]', eye(2)),...
                elltool.core.test.mlunit.EllipsoidDispStructTC.ellipsoid.fromRepMat(1, 1, [5 5 5]),...
                elltool.core.test.mlunit.EllipsoidDispStructTC.ellipsoid.fromRepMat(1, 1, [5 5 5])};
            objArrCVec{7}(1) = elltool.core.test.mlunit.EllipsoidDispStructTC.ellipsoid();
        end
        ...
        function objArrCVec = getFromStructObj()
            objArrCVec = {elltool.core.test.mlunit.EllipsoidDispStructTC.ellipsoid([1, 1]', eye(2)),...
                ...
                elltool.core.test.mlunit.EllipsoidDispStructTC.ellipsoid.fromRepMat(1, 1, [5 5 5]),...
                elltool.core.test.mlunit.EllipsoidDispStructTC.ellipsoid.fromRepMat(1, 1, [5 5 5])};
            objArrCVec{6}(1) = elltool.core.test.mlunit.EllipsoidDispStructTC.ellipsoid();
        end
        ...
        function objArrCVec = getDisplayObj()
            objArrCVec = {elltool.core.test.mlunit.EllipsoidDispStructTC.ellipsoid([1, 1]', eye(2)),...
                elltool.core.test.mlunit.EllipsoidDispStructTC.ellipsoid(),...
                elltool.core.test.mlunit.EllipsoidDispStructTC.ellipsoid([1, 2]', eye(2)),...
                elltool.core.test.mlunit.EllipsoidDispStructTC.ellipsoid.fromStruct(struct('shapeMat',...
                num2cell(ones(5, 5, 5)), ...
                'centerVec', num2cell(ones(5, 5, 5)))),...
                elltool.core.test.mlunit.EllipsoidDispStructTC.ellipsoid.fromStruct(struct('shapeMat', ...
                num2cell(ones(5, 5, 5)), ...
        ...
        function objArrCVec = getEqFstObj()
            objArrCVec = {elltool.core.test.mlunit.EllipsoidDispStructTC.ellipsoid([1, 1]', eye(2)),...
                ...
                num2cell(ones(5, 5, 5)), ...
                'centerVec', num2cell(ones(5, 5, 5)))),...
                elltool.core.test.mlunit.EllipsoidDispStructTC.ellipsoid.fromRepMat([1, 1]', eye(2), [1 2])};
        end
        ...
        function objArrCVec = getEqSndObj()
            objArrCVec = {elltool.core.test.mlunit.EllipsoidDispStructTC.ellipsoid([1, 1]', eye(2)),...
                ...
                'centerVec', num2cell(ones(5, 5, 5)))),...
                elltool.core.test.mlunit.EllipsoidDispStructTC.ellipsoid.fromRepMat([1, 1]', eye(2), [1 2])};
            objArrCVec{7}(1, 1, 1) = elltool.core.test.mlunit.EllipsoidDispStructTC.ellipsoid();
        end
