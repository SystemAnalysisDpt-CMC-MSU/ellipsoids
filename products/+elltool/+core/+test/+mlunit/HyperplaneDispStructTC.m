classdef HyperplaneDispStructTC < elltool.core.test.mlunit.ADispStructTC
    ...
    methods (Access = protected, Static)
        ...
        function objArrCVec = getToStructObj()
            import elltool.core.test.mlunit.HyperplaneDispStructTC;
            hpObj = HyperplaneDispStructTC.hyperplane();
            objArrCVec = {HyperplaneDispStructTC.hyperplane([1, 1, 2]', 3),...
                HyperplaneDispStructTC.hyperplane(),...
                HyperplaneDispStructTC.hyperplane([1, 1, 2]', 3),...
                HyperplaneDispStructTC.hyperplane([1, 1, 2]', 3),...
                HyperplaneDispStructTC.hyperplane([1, 1, 2]', 2),...
                hpObj.fromRepMat(1, 1, [5 5 5]),...
                hpObj.fromRepMat(1, 1, [5 5 5])};
            objArrCVec{7}(1) = HyperplaneDispStructTC.hyperplane();
        end
        ...
        function objArrCVec = getFromStructObj()
            import elltool.core.test.mlunit.HyperplaneDispStructTC;
            hpObj = HyperplaneDispStructTC.hyperplane();
            objArrCVec = {HyperplaneDispStructTC.hyperplane([1, 2]', 3),...
                HyperplaneDispStructTC.hyperplane([1, 2]', 3),...
                HyperplaneDispStructTC.hyperplane(),...
                HyperplaneDispStructTC.hyperplane([1, 2]', 3),...
                hpObj.fromRepMat(1, 1, [5 5 5]),...
                hpObj.fromRepMat(1, 1, [5 5 5])};
            objArrCVec{6}(1) = HyperplaneDispStructTC.hyperplane();
        end
        ...
        function objArrCVec = getDisplayObj()
            ...
            objArrCVec = {HyperplaneDispStructTC.hyperplane([1, 2]', 3),...
                HyperplaneDispStructTC.hyperplane(),...
                HyperplaneDispStructTC.hyperplane([1, 1]', 3),...
                hpObj.fromStruct(struct('normal',...
                num2cell(ones(5, 5, 5)), ...
                'shift', num2cell(ones(5, 5, 5)))),...
                HyperplaneDispStructTC.hyperplane([1, 2]', 3), ...
                HyperplaneDispStructTC.ellipsoid()};
