...
%            System Analysis Department 2013 $
    ...
    figRegExpList = {'[a-zA-Z_0-9:;,\]\[\s]*_tube_without_disturbance\w*', '[a-zA-Z_0-9:;,\]\[\s]*_set_without_disturbance\w*',...
                     '[a-zA-Z_0-9:;,\]\[\s]*_tube_with_disturbance\w*', '[a-zA-Z_0-9:;,\]\[\s]*_set_with_disturbance\w*'};
    elltool.doc.picgen.PicGenController.savePicFileNameByCaller(hFigHandleVec, 0.6, 0.6, 2, 2,...
    'figRegExpList', figRegExpList, 'viewAngleList', viewAngleList);
