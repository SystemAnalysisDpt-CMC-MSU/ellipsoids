    ...
    methods
        ...
        function self = testRegularization(self)
            ...
            self.runAndCheckError(...
                ...
                'ELLTOOL:REACH:REACHCONTINUOUS:wrongInput:badCalcPrec');
            %
            ...
            self.runAndCheckError(...
                ...
                'ELLTOOL:REACH:REACHCONTINUOUS:wrongInput:regDisabled');
            %
            self.runAndCheckError(...
                ['elltool.reach.ReachContinuous(linSys, x0Ell,',...
                'l0Mat, timeVec, ''isRegEnabled'', true, ',...
                '''isJustCheck'', true, ''regTol'', regTol)'],...
                'ELLTOOL:REACH:REACHCONTINUOUS:wrongInput:onlyCheckEnabled');
            %
            ...
            self.runAndCheckError(...
                ...
                'ELLTOOL:REACH:REACHCONTINUOUS:wrongInput:badRegTol');
            %
            badODE45RegTol = 1e-3;
            self.runAndCheckError(...
                ['elltool.reach.ReachContinuous(linSys, x0Ell,',...
                ...
                'ELLTOOL:REACH:REACHCONTINUOUS:wrongInput:badRegTolODE45Failed');
            %
            ...
            self.runAndCheckError(...
                ...
                'l0Mat, timeVec, ''isRegEnabled'', false, ',...
                '''isJustCheck'', false, ''regTol'', regTol)'],...
                'ELLTOOL:REACH:REACHCONTINUOUS:wrongInput:badInitSet');
            %
            x0Ell = self.x0Ell.getCopy();
