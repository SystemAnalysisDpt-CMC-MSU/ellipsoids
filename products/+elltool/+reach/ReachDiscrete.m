classdef ReachDiscrete < elltool.reach.AReach
    ...
    methods (Access=protected)
        ...
        function linSys = getProbDynamics(self,atStrCMat,btStrCMat,...
                ptStrCMat,ptStrCVec,ctStrCMat,qtStrCMat,qtStrCVec, x0Mat,x0Vec,...
                timeLimVec,relTol,absTol) %#ok<INUSL>
            linSys = gras.ellapx.lreachuncert.probdyn. ...
                LReachProblemDynamicsFactory.createByParams(atStrCMat,btStrCMat,...
                ptStrCMat,ptStrCVec,ctStrCMat,qtStrCMat,qtStrCVec, x0Mat,x0Vec,...
                timeLimVec,relTol,absTol,true);
        end
    end
    %
    methods
