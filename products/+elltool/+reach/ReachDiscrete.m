classdef ReachDiscrete < elltool.reach.AReach
    ...
    methods (Access=protected)
        function [ellTubeRel,goodDirSetObj] = internalMakeEllTubeRel(self,...
        ...
        function [linSysAction, linSysOrigin] = getProbDynamics(self,atStrCMat,btStrCMat,...
                ptStrCMat,ptStrCVec,ctStrCMat,qtStrCMat,qtStrCVec, x0Mat,...
                x0Vec,timeLimVec,relTol,absTol) %#ok<INUSL>
            linSysAction = gras.ellapx.lreachuncert.probdyn. ...
                LReachProblemDynamicsFactory.createByParams(atStrCMat,...
                btStrCMat,ptStrCMat,ptStrCVec,ctStrCMat,qtStrCMat,...
                qtStrCVec, x0Mat,x0Vec,timeLimVec,relTol,absTol,true);
            linSysOrigin = linSysAction;
        end
    end
    %
    methods
