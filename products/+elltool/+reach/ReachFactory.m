classdef ReachFactory < handle
    ...
    methods (Static, Access = protected)
        function contReachObj = createContReachObjInstance(varargin)
            contReachObj = elltool.reach.ReachContinuous(varargin{:});
        end
        function discrReachObj = createDiscrReachObjInstance(varargin)
            discrReachObj = elltool.reach.ReachDiscrete(varargin{:});
        end
    end
    %
    methods
        ...
        function reachObj = createInstance(self, varargin)
            ...
            if ~self.reachObjMap.isKey(keyStr)
                ...
                elseif self.isEvolve
                    ...
                    reachObj = self.createContReachObjInstance(...
