classdef ReachFactory < handle
    ...
    methods (Access = private)
        function linSysObj = fGetSys(self, inpAtMat, inpBtMat,...
                inpUBoundMat, inpUBoundVec, inpGtMat, inpDistBoundMat,...
                inpDistBoundVec, inpCtMat,...
                inpNoiseBoundMat, inpNoiseBoundVec)
            if ~isempty(inpAtMat) && ~isempty(inpBtMat)
                ...
                if self.isDiscr
                    linSysObj = elltool.linsys.LinSysDiscrete(...
                        inpAtMat, inpBtMat, uBoundsEll, inpGtMat,...
                        distBoundsEll, inpCtMat, noiseBoundsEll, 'd');
                else
                    linSysObj = elltool.linsys.LinSysContinuous(...
                        inpAtMat, inpBtMat, uBoundsEll, inpGtMat,...
                        distBoundsEll, inpCtMat, noiseBoundsEll);
                end
            else     
    ...
    methods
        ...
        function reachObj = createInstance(self, varargin)
            ...
            [reg, isRegSpec, inpAtMat,inpBtMat, inpUBoundMat,...
                inpUBoundVec, inpGtMat, inpDistBoundMat,...
                inpDistBoundVec, inpCtMat, inpNoiseBoundMat,...
                inpNoiseBoundVec, inpX0EllMat, inpX0EllVec,...
                l0DirMat, timeVec] = parseparext(varargin,...
                {'At', 'Bt', 'controlMat', 'controlVec', 'Gt',...
                'disturbMat', 'disturbVec', 'Ct', 'noiseMat',...
                'noiseVec', 'x0EllMat','x0EllVec', 'l0Mat','tVec';...
                [], [], [], [], [], [], [], [], [], [],...
            ...
            if ~self.reachObjMap.isKey(keyStr)
                linSysObj = self.fGetSys(inpAtMat, inpBtMat,...
                    inpUBoundMat, inpUBoundVec, inpGtMat,...
                    inpDistBoundMat, inpDistBoundVec, inpCtMat,...
                    inpNoiseBoundMat, inpNoiseBoundVec);
