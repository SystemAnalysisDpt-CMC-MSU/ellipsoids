        ...
        function ellTubeRel = makeEllTubeRel(self, smartLinSys, l0Mat,...
            ...
            try
                ...
                if strcmp(exception.identifier,...
                    ...
                    errorTag = 'wrongInput:onlyCheckEnabled';
                end
                if strcmp(exception.identifier,...
                        'MATLAB:badsubscript')
                    errorStr = ['There is problem with regularization ',...
                ...
                if strcmp(exception.identifier,...
                    ...
                    errorStr = ['Problems with ode45reg found, ',...
                        'please, increase regularization tolerance.'];
                ...
                if strcmp(exception.identifier,...
                    ...
                    errorStr = ['Problems with calculation precision. ',...
                        'Try to decrease the length of your time ',...
                        'interval or initial set or control ellipsoid, ',...
                        'or distorbance ellipsoid.'];
                    errorTag = 'wrongInput:badCalcPrec';
                end
                if strcmp(exception.identifier,...
                        ['GRAS:ELLAPX:LREACHUNCERT:EXTINTELLAPXBUILDER',...
                        ':EXTINTELLAPXBUILDER:wrongInput'])
                    errorStr = ['Problems with initial set found. ',...
                        'Try to increase initial ellipsoid'];
                    errorTag = 'wrongInput:badInitSet';
                end
                if strcmp(exception.identifier,...
                        ['GRAS:ELLAPX:LREACHUNCERT:EXTINTELLAPXBUILDER',...
                        ':CALCELLAPXMATRIXDERIV:wrongInput'])
                    errorStr = 'Try to use regularization.';
