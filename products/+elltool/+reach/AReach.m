classdef AReach < elltool.reach.IReach
    ...
    methods (Abstract, Access = protected)
        ...
        [linSysAction, linSysOrigin] = getProbDynamics(self,atStrCMat,btStrCMat, ...
    ...
    methods (Access = private)
        function [ellTubeRelList, indVec,probDynObjCell,goodDirSetObjCell]=...
            ...
            for il0Num = l0VecNum: -1 : 1
                [probDynActionObj, probDynOriginObj] = self.getProbDynamics(atStrCMat,btStrCMat, ...
                    ptStrCMat, ptStrCVec, ctStrCMat,qtStrCMat,qtStrCVec, ...
    ...
    methods
        function self=AReach(linSys, x0Ell, l0Mat, timeVec, varargin)
            ...
            if nargin>0
                ...
                %               
                [self.ellTubeRel,goodDirSetObj,probDynActionObj] =...
                    self.makeEllTubeRel(probDynActionObj, l0Mat,...
        ...
        function [directionsCVec, timeVec,l0Mat] = get_directions(self)
            % GET_DIRECTIONS returns a list of "good direction" curves
            ...
            %           object
            % Output:
            %   directionsCVec: cell[1,nTubes] of [nDims,nTimePoints] -
            %       list of good curves 
            %
