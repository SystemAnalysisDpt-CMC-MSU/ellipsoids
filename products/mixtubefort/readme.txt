...
1.	Put blas.lib and lapack.lib into dependencies directory
2.  Put fmpich2.lib and mpi.lib from %MPICH2_INSTALL_DIRECTORY%\lib into
	dependencies directory
3.  Put libmat.lib and libmx.lib from 
