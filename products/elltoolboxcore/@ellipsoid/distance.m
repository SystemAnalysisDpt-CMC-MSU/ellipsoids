...
% Input:
%   regular:
%       ellObjArr: ellipsoid [nDims1, nDims2,..., nDimsN] -
%           array of ellipsoids of the same dimension.
%       objArray: double / ellipsoid / hyperplane /
%           polytope [nDims1, nDims2,..., nDimsN] - array 
%           of vectors or ellipsoids or hyperplanes or 
%           polytopes. If number of elements in objArray 
%           is more than 1, then it must be equal to the 
%           number of elements in ellObjArr.
%
%   optional:
%       isFlagOn: logical[1,1] - if true then distance is
%            computed in ellipsoidal metric, if false - in
%            Euclidean metric (by default isFlagOn=false).
%
% Output:
%   regular:
%     distValArray: double [nDims1, nDims2,..., nDimsN] - 
%           array of pairwise calculated distances.
%           Negative distance value means
%               for ellipsoid and vector: vector belongs to
%                   the ellipsoid,
...
%   optional:
%       statusArray: double [nDims1, nDims2,..., nDimsN] - 
%           array of time of computation of 
%           ellipsoids-vectors or ellipsoids-ellipsoids
%           distances, or status of cvx solver for 
%           ellipsoids-polytopes distances.
%
%
