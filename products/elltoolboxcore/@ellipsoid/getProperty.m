...
%GETPROPERTY gives array the same size as ellArr with values of propName properties
%for each ellipsoid in ellArr. Private method, used in every public
%property getter.
%
% Input:
%   regular:
...
%
% Output:
%   propValArr:double[nDim1, nDim2,...]- multidimension array of propName properties for
