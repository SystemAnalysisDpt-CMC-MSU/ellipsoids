...
%
% ISINTERNAL - checks if given points belong to the union 
%              or intersection of ellipsoids in the given
%              array.
%
% isPositiveVec = ISINTERNAL(myEllArr,matrixOfVecMat,mode)
%       - Checks if vectors specified as columns of matrix 
%       matrixOfVecMat belong to the union (mode = 'u'), or 
%       intersection (mode = 'i') of the ellipsoids in 
%       myEllArr. If myEllArr is a single ellipsoid, then 
%       this function checks if points in matrixOfVecMat 
%       belong to myEllArr or not. Ellipsoids in myEllArr
%       must be of the same dimension. Column size of 
%       matrix  matrixOfVecMat should match the dimension 
%       of ellipsoids.
%
