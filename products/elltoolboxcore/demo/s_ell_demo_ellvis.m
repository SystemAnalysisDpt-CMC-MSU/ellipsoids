...
subplot(2, 2, 2); minkdiff(projection(E32.getCopy(), B1),...
    projection(E.getCopy(), B1), o),
title('(b) Projection on basis B1'); xlabel('x_1'); ylabel('x_2');
subplot(2, 2, 3); minkdiff(projection(E32.getCopy(), B2),...
    projection(E.getCopy(), B2), o),
title('(c) Projection on basis B2'); xlabel('x_1'); ylabel('x_3');
subplot(2, 2, 4); minkdiff(projection(E32.getCopy(), B3),...
    projection(E.getCopy(), B3), o),
title('(d) Projection on basis B3'); xlabel('x_2'); ylabel('x_3');
%% 
