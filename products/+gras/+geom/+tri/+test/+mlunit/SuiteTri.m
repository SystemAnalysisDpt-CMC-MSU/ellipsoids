classdef SuiteTri < mlunitext.test_case
    ...
    methods
        ...
        function testShrinkFaceTriOneFace(self)
            ...
            mlunit.assert_equals(true,isequal(v1Mat,v1ExpMat));
            mlunit.assert_equals(true,isequal(f1Mat,f1ExpMat));
            fMat=[3 2 1];
        ...
        function testShrinkFaceTri3Face1Part(self)
            ...
            mlunit.assert_equals(true,all(isFaceThereVec));
            %
        ...
        function testIsFace(self)
            ...
            mlunit.assert_equals(true,isequal(isFaceThereVec,...
        ...
        function testMapFace2Edge(self)
            ...
            mlunit.assert_equals(true,isequal(eMat,eExpMat));
            mlunit.assert_equals(true,isequal(f2eMat,f2eExpMat));
            mlunit.assert_equals(true,isequal(f2eIsDirMat,f2eExpIsDirMat));
        end
        %
        function testShrinkFaceTri(self)
            ...
            for iDataSet=N_DATA_SETS:-1:1
                ...
                mlunit.assert_equals(true,isOldVertsKept);
                ...
                mlunit.assert_equals(true,isequal(SOut,SEOut));
            end
            function [v1Mat,f1Mat]=shrink(v0Mat,f0Mat)
                ...
                mlunit.assert_equals(true,isequal(v1Mat,v2Mat));
                mlunit.assert_equals(true,isequal(f1Mat,f2Mat));
                mlunit.assert_equals(true,isequal(S1Stat,S2Stat));
                %
        ...
        function [vMat,fMat,SStats]=aux_shrinkfacetri(~,vMat,fMat,varargin)
            ...
            [vMat,fMat,SStats,eMat,f2eMat]=shrinkfacetri(...
                vMat,fMat,varargin{:});
            nEdges=size(eMat,1);
            mlunit.assert_equals(nEdges,length(unique(f2eMat)));
        end
        function testSphereTri(~)
            ...
            function check(depth)
                ...
                mlunit.assert_equals(true,vol1>vol0);
                mlunit.assert_equals(true,vol1<pi*4/3);
                mlunit.assert_equals(true,size(cf0,1)*4==size(cf1,1));
                %
