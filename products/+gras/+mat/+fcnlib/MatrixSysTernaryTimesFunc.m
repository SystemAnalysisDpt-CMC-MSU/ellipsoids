classdef MatrixSysTernaryTimesFunc<gras.mat.AMatrixSysTernaryOpFunc
    methods
        function self=MatrixSysTernaryTimesFunc(lMatFunc, mMatFunc,...
                rMatFunc)
            %
            self=self@gras.mat.AMatrixSysTernaryOpFunc(lMatFunc,...
