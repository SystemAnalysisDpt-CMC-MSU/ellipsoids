    ...
    methods
        ...
        function testConstMatrixFunctionFactory(self)
            ...
            f = gras.mat.ConstMatrixFunctionFactory.createInstance(...
                {'1'});
            mlunit.assert_equals(isa(f,'gras.mat.fcnlib.ConstMatrixFunction'),...
                true);
            aMatExpected = [1];
            ...
            f = gras.mat.ConstMatrixFunctionFactory.createInstance(...
                {'1','2'});
            mlunit.assert_equals(isa(f,'gras.mat.fcnlib.ConstRowFunction'),...
                true);
            aMatExpected = [1 2];
            aMatObtained = f.evaluate(0);
            isOkMat = ( aMatExpected == aMatObtained );
            ...
            f = gras.mat.ConstMatrixFunctionFactory.createInstance(...
                {'1';'2'});
            mlunit.assert_equals(isa(f,'gras.mat.fcnlib.ConstColFunction'),...
                true);
            aMatExpected = [1; 2];
            aMatObtained = f.evaluate(0);
            isOkMat = ( aMatExpected == aMatObtained );
