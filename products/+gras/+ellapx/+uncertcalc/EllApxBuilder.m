classdef EllApxBuilder<handle
    ...
    methods (Static,Access=public)
        ...
        %
        function builderList=buildApxGroupGeneric(className, apxName, ...
                confRepoMgr, fBuildOne)
            ...
            for iSchema=1:nSchemas
                ...
                if confRepoMgr.getParam([schemaPath,'.isEnabled'])
                    builderList{iSchema} = fBuildOne(...
                       feval([className '.getApxBuilder'], apxName, ...
                       schemaName), ...
    ...
    methods
        ...
        function self=EllApxBuilder(confRepoMgr,pDynObj,goodDirSetObj)
            ...
            %
            intBuilderList=self.buildApxGroupGeneric(class(self), ...
                'internalApx',confRepoMgr,fBuildOne);
            extBuilderList=self.buildApxGroupGeneric(class(self), ...
                'externalApx',confRepoMgr,fBuildOne);
            extIntBuilderList=self.buildApxGroupGeneric(class(self), ...
