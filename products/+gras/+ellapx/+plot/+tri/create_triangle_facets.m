function facet_data=create_triangle_facets(vertex_data,epoints_num,points_num)
td=1:1:(points_num);
...
facet_data=zeros((points_num-1)*epoints_num*2,3);
for d=1:1:3
    facet_data(:,d)=[part1_facet_data_1(:,d);part1_facet_data_2(:,d);part2_facet_data_1(:,d);part2_facet_data_2(:,d)];
end;