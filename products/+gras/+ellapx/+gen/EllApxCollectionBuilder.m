classdef EllApxCollectionBuilder<gras.ellapx.gen.IEllApxBuilder
    ...
    methods
        ...
        function ellTubeRel=getEllTubes(self)
            ...
            for iBuilder=1:nBuilders
                %tStart=tic;
                selfBuilderListGetEllTubes1=self.builderList{iBuilder}.getEllTubes();
                selfBuilderListGetCalcPrecision1=self.builderList{iBuilder}.getCalcPrecision();
                [ ellTubeRel ]=elltool.pcalc.fCalcTube5(selfBuilderListGetEllTubes1,...
                    ellTubeRel, logger, selfBuilderListGetCalcPrecision1)
