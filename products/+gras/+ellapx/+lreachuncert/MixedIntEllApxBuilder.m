classdef MixedIntEllApxBuilder<gras.ellapx.gen.ATightEllApxBuilder
    ...
    methods
        function self=MixedIntEllApxBuilder(pDynObj,goodDirSetObj,...
            ...
            %
            [~,~,sMethodName,mixingStrength,...
                mixingProportionsCMat,nTimeGridPoints] = ...
                modgen.common.parseparext(varargin,...
                {'selectionMethodForSMatrix','mixingStrength',...
                'mixingProportions', 'nTimeGridPoints';...
                [],[],[],MixedIntEllApxBuilder.N_TIME_POINTS}, 0, 4,...
                'isObligatoryPropVec',[true true true false]);
            %
