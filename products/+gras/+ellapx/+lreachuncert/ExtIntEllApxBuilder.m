    ...
    methods (Access=private)
        ...
        function build(self)
            ...
            fOdeReg=@(t,QIntMat,QExtMat)calcRegEllApxMatrix(self,...
                QIntMat,QExtMat);
            %
            solverObj=MatrixSysODERegInterpSolver({[sysDim,sysDim],[sysDim,sysDim]},...
            ...
            for iDir=1:1:nLDirs
                ...
                %
                [~,QStarIntArray,QStarExtArray,MIntArray,MExtArray,interpObj]=...
            ...
            self.ellTubeRel=...
                gras.ellapx.smartdb.rels.EllTube.fromQMInterpListInternal(...
                interpObjList,aMatInterpObj,resTimeVec,ltGoodDirInterpObj,...
...
%                 self.getCalcPrecision));
            self.ellTubeRel.unionWith(...
                gras.ellapx.smartdb.rels.EllTube.fromQMInterpListExternal(...
                interpObjList,aMatInterpObj,resTimeVec,ltGoodDirInterpObj,...
                sTime,gras.ellapx.enums.EApproxType.External,...
                apxSchemaName,apxSchemaDescr,...
                self.getCalcPrecision));
