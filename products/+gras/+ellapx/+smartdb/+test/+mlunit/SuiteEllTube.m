classdef SuiteEllTube < mlunitext.test_case
    methods
        ...
        function self = testIsEqual(self)
            ...
            % self equal
            [isEqual, reportStr] = mixedExtIntEllTube.isEqual(...
                mixedExtIntEllTube);            
            mlunitext.assert(isEqual, reportStr);            
            [isEqual, reportStr] = nonMixedEllTube.isEqual(...
                nonMixedEllTube);
            mlunitext.assert(isEqual, reportStr);
            ...
            interpMixedEllTube = ...
                mixedExtIntEllTube.interp([1,1.5,2,2.5,3]);
            interpMixed2EllTube = ...
                mixedExtInt2EllTube.interp([1,1.5,2,2.5,3]);
            [isEqual, reportStr] = mixedExtIntEllTube.isEqual(...
                interpMixedEllTube);
            mlunitext.assert(isEqual, reportStr);
            [isEqual, reportStr] = interpMixedEllTube.isEqual(...
                mixedExtInt2EllTube);
            mlunitext.assert(isEqual, reportStr);
            [isEqual, reportStr] = interpMixed2EllTube.isEqual(...
                mixedExtInt2EllTube);
            mlunitext.assert(isEqual, reportStr);
            ...
            smallerMixedEllTube = ...
                gras.ellapx.smartdb.rels.EllTube.fromQArrays(...
                {q2MatArray,q2MatArray,q2MatArray}, a2Mat, [1,3],...
                [ls2GoodDirArray,ls2GoodDirArray,ls2GoodDirArray],sTime,...
                [approx1Type,approx2Type,approx1Type]',...
                approxSchemaName,...
                approxSchemaDescr, CALC_PRECISION);
            [isEqual, reportStr] = smallerMixedEllTube.isEqual(...
                mixedExtInt2EllTube);
            mlunitext.assert(isEqual, reportStr);
            ...
            badTimedMixedEllTube = ...
                gras.ellapx.smartdb.rels.EllTube.fromQArrays(...
                {q2MatArray,q2MatArray,q2MatArray}, a2Mat, [1,4],...
                [ls2GoodDirArray,ls2GoodDirArray,ls2GoodDirArray],sTime,...
                [approx1Type,approx2Type,approx1Type]',...
                approxSchemaName,...
                approxSchemaDescr, CALC_PRECISION);
            [isEqual, reportStr] = badTimedMixedEllTube.isEqual(...
                smallerMixedEllTube);
            mlunitext.assert(~isEqual, reportStr);
            % projection
            projSpaceList = {[1,0;0,1].'};
            ...
            proj2EllTube = interpMixedEllTube.project(projType,...
                projSpaceList, @fGetProjMat);
            [isEqual, reportStr] = projEllTube.isEqual(...
                proj2EllTube);
            mlunitext.assert(isEqual, reportStr);
