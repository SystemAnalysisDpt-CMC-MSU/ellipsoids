    ...
    methods
        ...
        function testCutAndCat(~)
            ...
            function rel = create(timeVec)
                ...
                rel = ellTubeFactory.fromQArrays(QArrayList,aMat,timeVec,...
                    ltGoodDirArray,timeVec(1),...
        ...
        function testRegCreate(self)
            ...
            function checkMaster(fGetScaleAndReg)
                ...
                [~,~,scaleFactor,MArrayList]=fGetScaleAndReg(true,true);
                ...
                function rel=create()
                    ...
                    ellTubeFactory=gras.ellapx.smartdb.EllTubeFactory('tight');
                    rel=ellTubeFactory.fromQMScaledArrays(...
        ...
        function testProjectionAndScale(~)
            ...
            function rel=create()
                ltGoodDirArray=repmat(lsGoodDirVec,[1,nTubes,nPoints]);
                ellTubeFactory=gras.ellapx.smartdb.EllTubeFactory('tight');
                ellTubeFactory.fromQMScaledArrays(...
                    QArrayList,aMat,MArrayList,timeVec,...
                    ltGoodDirArray,sTime,approxType,approxSchemaName,...
                    approxSchemaDescr,calcPrecision,...
                    scaleFactor(ones(1,nTubes)));
                rel=ellTubeFactory.fromQMArrays(...
                    QArrayList,aMat,MArrayList,timeVec,...
                    ltGoodDirArray,sTime,approxType,approxSchemaName,...
                    approxSchemaDescr,calcPrecision);
            end
        ...
        function testPlotTouch(self)
            [relStatProj,relDynProj]=checkMaster(10);
        ...
        function [rel,relStatProj,relDynProj]=auxGenSimpleTubeAndProj(~,...
            ...
            function rel=create()
                ltGoodDirArray=repmat(lsGoodDirVec,[1,nTubes,nPoints]);
                ellTubeFactory=gras.ellapx.smartdb.EllTubeFactory('tight');
                rel=ellTubeFactory.fromQArrays(...
        ...
        function testEllTubeFromEllArray(~)
            ...
            ellTubeFactory=gras.ellapx.smartdb.EllTubeFactory('tight');
            %
            fromMatEllTube=ellTubeFactory.fromQArrays(...
                qArrayList, aMat, timeVec,...
                ltGoodDirArray, sTime, approxType, approxSchemaName,...
                approxSchemaDescr, calcPrecision);
            fromMatMEllTube=ellTubeFactory.fromQMArrays(...
                qArrayList, aMat, mArrayList, timeVec,...
                ltGoodDirArray, sTime, approxType, approxSchemaName,...
                approxSchemaDescr, calcPrecision);
            fromEllArrayEllTube=ellTubeFactory.fromEllArray(...
                ...
                ltGoodDirArray, sTime, approxType, approxSchemaName,...
                approxSchemaDescr, calcPrecision);
            fromEllMArrayEllTube=ellTubeFactory.fromEllMArray(...
        ...
        function self = testEllArrayFromEllTube(self)
            ...
            ellTubeFactory=gras.ellapx.smartdb.EllTubeFactory('tight');
            %
            extFromEllArrayEllTube = ellTubeFactory.fromEllArray(...
                ellArray, timeVec,...
            ...
            %
            intFromEllArrayEllTube = ellTubeFactory.fromEllArray(...
                ellArray, timeVec,...
        ...
        function self = testUnionFromEllTubes(self)
            ...
            calcPrecision=0.001;
            testEllTube = ...
                gras.ellapx.smartdb.EllTubeFactory('tight').fromEllArray(...
                ellArray, timeVec,...
                lsGoodDirArray, sTime, EApproxType.External, ...
                approxSchemaName,...
                approxSchemaDescr, calcPrecision);
