classdef EllTube<gras.ellapx.smartdb.rels.ATypifiedAdjustedRel&...
    ...
    methods (Static)
        ...
        function ellTubeRel=fromQArrays(QArrayList,aMat,varargin)
            ...
            aMatInterpObj = ...
                gras.interp.MatrixNearestInterp(aMat,varargin{1});
            ltGoodDirInterObj = gras.interp.MatrixNearestInterp(varargin{2},varargin{1});
            ...
            %STubeData = EllTube.unificationInterpObjs(STubeData);
