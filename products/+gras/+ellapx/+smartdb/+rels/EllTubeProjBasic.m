    ...
    methods
        ...
        function interpolatedEllTube = interp(self, timeVec)
            if isempty(self) 
                ...
                interpolatedEllTube = ...
                    interp@gras.ellapx.smartdb.rels.EllTubeBasic(...
                    self, timeVec); 
                nTuples = length(self.QArray);
                STubeData = struct;
                STubeData.projSTimeMat = self.projSTimeMat;
                STubeData.projType = self.projType;
                STubeData.lsGoodDirNormOrig = ...
                    self.lsGoodDirNormOrig;
                STubeData.lsGoodDirOrigVec = ...
                    self.lsGoodDirOrigVec;
                ltGoodDirNormOrigVecSplineList = ...
                    arrayfun(@(iData)fCalcRowSpline(iData,...
                    self.ltGoodDirNormOrigVec), 1:nTuples,...
                    'UniformOutput', false);
                STubeData.ltGoodDirNormOrigVec = ...
                    arrayfun(@(iData)...
                    (ltGoodDirNormOrigVecSplineList{iData}.evaluate(...
                    timeVec)), 1:nTuples, 'UniformOutput', false)';
                STubeData.QArray = interpolatedEllTube.QArray;
                STubeData.aMat = interpolatedEllTube.aMat;
                STubeData.scaleFactor = interpolatedEllTube.scaleFactor;
                STubeData.MArray = interpolatedEllTube.MArray;
                STubeData.dim = interpolatedEllTube.dim;
                STubeData.sTime = interpolatedEllTube.sTime;
                STubeData.approxSchemaName = ...
                    interpolatedEllTube.approxSchemaName;
                STubeData.approxSchemaDescr = ...
                    interpolatedEllTube.approxSchemaDescr;
                STubeData.approxType =...
                    interpolatedEllTube.approxType;
                STubeData.timeVec = ...
                    interpolatedEllTube.timeVec;
                STubeData.calcPrecision = ...
                    interpolatedEllTube.calcPrecision;
                STubeData.indSTime = interpolatedEllTube.indSTime;
                STubeData.ltGoodDirMat = interpolatedEllTube.ltGoodDirMat;
                STubeData.lsGoodDirVec = interpolatedEllTube.lsGoodDirVec;
                STubeData.ltGoodDirNormVec = ...
                    interpolatedEllTube.ltGoodDirNormVec;
                STubeData.lsGoodDirNorm = ...
                    interpolatedEllTube.lsGoodDirNorm;
                STubeData.xTouchCurveMat = ...
                    interpolatedEllTube.xTouchCurveMat;
                STubeData.xTouchOpCurveMat = ...
                    interpolatedEllTube.xTouchOpCurveMat;
                STubeData.xsTouchVec = interpolatedEllTube.xsTouchVec;
                STubeData.xsTouchOpVec = interpolatedEllTube.xsTouchOpVec;
                interpolatedEllTube = ...
                    gras.ellapx.smartdb.rels.EllTubeProj(STubeData);
            end
            %
            function vecSpline = fCalcRowSpline(iData, rowList)
                import gras.interp.MatrixInterpolantFactory;
                vecSpline = MatrixInterpolantFactory.createInstance(...
                'column', rowList{iData}, self.timeVec{iData});
            end
        end
    end
end