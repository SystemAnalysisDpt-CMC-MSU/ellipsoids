classdef EllTubeProjBasic<gras.ellapx.smartdb.rels.EllTubeBasic&...
    ...
    methods (Access=protected)
        ...
        %
        function hVec = plotCreateReachTubeFunc(self,patchColor,...
                patchAlpha, lineWidth, hAxes,projType,...
            ...
            hVec = self.plotCreateGenericTubeFunc(hAxes,...
                ...
                approxType, QArray, aMat, patchColor,...
                patchAlpha, self.REACH_TUBE_PREFIX);
            axis(hAxes,'tight');
            axis(hAxes,'normal');
        ...
        function hVec=plotCreateRegTubeFunc(self,hAxes,~,...
            ...
            if approxType==EApproxType.Internal
                patchColor =...
                    getRegTubeColor(self,approxType);
                patchAlpha =...
                    getRegTubeAlpha(self, approxType);
                hVec = self.plotCreateGenericTubeFunc(hAxes,...
                    timeVec, lsGoodDirOrigVec, sTime,...
                    approxType, MArray,zeros(size(aMat)),...
                    patchColor, patchAlpha, self.REG_TUBE_PREFIX);
            else
                hVec=[];
            end
        end
    ...
    methods
        function plObj=plot(self,varargin)
            ...
            [reg, isRegSpec, fGetPatchColor, fGetAlpha, fGetLineWidth,...
            ...
            checkListOfField();
            patchColor = ...
                self.applyTupleGetFunc(fGetPatchColor, colorFieldList);
            patchAlpha = self.applyTupleGetFunc(fGetAlpha, alphaFieldList);
            lineWidth = self.applyTupleGetFunc(fGetLineWidth, widthFieldList);
            isFill = self.applyTupleGetFunc(fGetFill, fillFieldList);
            
            patchColor = patchColor(1, :);
            patchAlpha = patchAlpha(1);
            ...
            if self.getNTuples()>0
                ...
                fPlotReachTube=@(varargin)plotCreateReachTubeFunc(self,...
                    patchColor, patchAlpha, lineWidth,...
                    varargin{:});
