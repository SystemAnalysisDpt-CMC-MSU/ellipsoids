classdef EllUnionTubeStaticProj<gras.ellapx.smartdb.rels.TypifiedByFieldCodeRel&...
    ...
    methods (Access = protected)
        function fieldsList = getNoCatOrCutFieldsList(~)
            ...
            'LS_GOOD_DIR_NORM_ORIG';'LS_GOOD_DIR_ORIG_VEC';... 
            'PROJ_S_MAT';'PROJ_TYPE'};
        end
        ...
        function fieldsList = getTFieldsList(~)
            ...
            'IS_LT_TOUCH_OP_VEC';'LT_GOOD_DIR_NORM_ORIG_VEC';...
            'LT_GOOD_DIR_ORIG_MAT'};
        end
        function fieldsList = getScalarFieldsList(~)
            fieldsList = {'LS_GOOD_DIR_NORM','LS_GOOD_DIR_NORM_ORIG';...
                'IS_LS_TOUCH';'IS_LS_TOUCH_OP'};
        end
    end
    methods(Access=protected)
