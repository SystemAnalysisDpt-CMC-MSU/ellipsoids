    ...
    methods (Access=protected)
        ...
        function SData = getInterpInternal(self, newTimeVec)
            ...
            if (~isempty(newTimeVec))
                 fieldList={F.Q_ARRAY,F.A_MAT,F.SCALE_FACTOR,...
                    F.M_ARRAY,F.DIM,F.S_TIME,F.APPROX_SCHEMA_NAME,...
                    F.APPROX_SCHEMA_DESCR,F.APPROX_TYPE,F.TIME_VEC,...
                    F.CALC_PRECISION,F.IND_S_TIME,F.LT_GOOD_DIR_MAT,...
                    F.LS_GOOD_DIR_VEC,F.LT_GOOD_DIR_NORM_VEC,...
                    F.LS_GOOD_DIR_NORM,F.X_TOUCH_CURVE_MAT,...
                    F.X_TOUCH_OP_CURVE_MAT,F.XS_TOUCH_VEC,...
                    F.XS_TOUCH_OP_VEC};
            ...
            function [QArray, aMat, scaleFactor, MArray, dim, sTime,...
                ...
                ltGoodDirNormSpline = ...
                    MatrixInterpolantFactory.createInstance(...
                    'column', ltGoodDirNormVec, timeVec);
                centSpline = ...
                    MatrixInterpolantFactory.createInstance(...
                    'column', aMat, timeVec);  
                ...
                ltGoodDirNormVec =...
                    {ltGoodDirNormSpline.evaluate(newTimeVec)};
