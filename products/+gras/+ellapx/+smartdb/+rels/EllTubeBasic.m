...
%                 [SData.QArray, SData.aMat, SData.MArray, SData.timeVec,...
%                     SData.approxSchemaName, SData.approxSchemaDescr,...
%                     SData.lsGoodDirVec, SData.ltGoodDirNormVec,...
%                     SData.ltGoodDirMat, SData.xTouchCurveMat,...
%                     SData.xTouchOpCurveMat,SData.xsTouchVec,...
%                     SData.xsTouchOpVec] = ...
%                     [{SData.QArray}, {SData.aMat}, {SData.MArray},...
%                     {SData.timeVec}, {SData.approxSchemaName},...
%                     {SData.approxSchemaDescr}, {SData.lsGoodDirVec},...
%                     {SData.ltGoodDirNormVec}, {SData.ltGoodDirMat},...
%                     {SData.xTouchCurveMat}, {SData.xTouchOpCurveMat},...
%                     {SData.xsTouchVec}, {SData.xsTouchOpVec}];
            end
            %
